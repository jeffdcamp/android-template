...
class AcknowledgementViewModel(
    ...
    private fun loadLicenses() {
        ...
        // read the file
        acknowledgementHtmlStateFlow.value = runCatching {
            application.assets.open(htmlFilename).bufferedReader().use { it.readText() }
        }.getOrElse { e ->
            Logger.e(e) { "Failed to render Acknowledgments html" }
