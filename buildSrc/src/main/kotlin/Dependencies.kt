...
object Deps {
    ...
    const val ANDROIDX_FRAGMENT_KTX = "androidx.fragment:fragment-ktx:1.2.2"
    ...
    // Play Services
    const val PLAYSERVICE_CORE = "com.google.android.play:core-ktx:1.6.5"
    ...
    // Network
    private const val OKHTTP_VERSION = "4.4.0" // https://github.com/square/okhttp/blob/master/CHANGELOG.md
